...
async function bootstrap(): Promise<void> {
  ...
  await tracingService.init("matching-service");
  ...
  setupSwagger(app, {
    ...
    description:
      "API documentation for Suggar Daddy Matching Service - Swipe, Match, Cards with Geo-filtering",
    version: "1.0",
    tag: "Matching",
    path: "api/docs",
  });
  ...
  Logger.log(
    `Matching Service running on: http://localhost:${port}/${globalPrefix}`,
  );
