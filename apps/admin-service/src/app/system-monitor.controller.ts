...
export class SystemMonitorController {
  ...
  /** GET /api/admin/system/health - 系統健康檢查（Redis + DB） */
  @Get('health')
  getSystemHealth() {
    return this.systemMonitorService.getSystemHealth();
  }

  /** GET /api/admin/system/kafka - Kafka 消費者狀態 */
  @Get('kafka')
  getKafkaStatus() {
  ...
  /** GET /api/admin/system/consistency - 資料一致性指標 */
  @Get('consistency')
  ...
  /** POST /api/admin/system/dlq/retry/:messageId - 重試單一 DLQ 訊息 */
  ...
  /** POST /api/admin/system/dlq/retry-all - 重試所有 DLQ 訊息 */
  @Post('dlq/retry-all')
  @HttpCode(200)
  retryAllDlqMessages() {
  ...
  /** DELETE /api/admin/system/dlq/messages/:messageId - 刪除單一 DLQ 訊息 */
  ...
  /** DELETE /api/admin/system/dlq/purge - 清除全部 DLQ 訊息 */
  @Delete('dlq/purge')
  purgeDlqMessages() {
