...
-- Creator account
INSERT INTO "users" (email, "passwordHash", "displayName", "userType", "permissionRole", "createdAt", "updatedAt")
VALUES (
  'creator@test.com',
...
SELECT email, "displayName", "userType", "permissionRole" FROM "users" WHERE email IN ('creator@test.com', 'subscriber@test.com', 'admin@test.com');
